...
namespace HSMS.Domain.Domains
{
    public class CompanyMasters
    {
        ...
        public CompanyMasters(int? id, string? companyID, string? companyName, int? companyCode, DateTime? installationDate, string? address, int? stateID, int? districtID, int? cityID, int? areaID, string? mobile1, string? mobile2, string? phone, string? contactPerson, int? cREATEUSERID, DateTime? cREATEDATE, string? cREATETERMINALID, int? eDITUSERID, DateTime? eDITDATE, string? eDITTERMINALID, int? countryid)
        {
            ID = id;
            CompanyID = companyID;
